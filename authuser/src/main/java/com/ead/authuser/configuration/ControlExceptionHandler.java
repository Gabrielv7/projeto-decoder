...
import com.ead.authuser.exception.StandadError;
import com.ead.authuser.exception.NotFoundException;
import com.ead.authuser.exception.StandadValidationError;
...
public class ControlExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleBusinessException(BusinessException ex, WebRequest request) {
        ...
        return ResponseEntity.badRequest().body(standadError);
    }

    @ExceptionHandler(NotFoundException.class)
    public ResponseEntity<Object> handleNotFoundException(NotFoundException ex, WebRequest request) {
        StandadError standadError = buildErrorResponse(ex, NOT_FOUND, request.getContextPath());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(standadError);
    }
